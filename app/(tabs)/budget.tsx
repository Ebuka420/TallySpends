...
const SUGGESTED_PROMPTS = [
  ...
  "How can I save Γéª50,000 next month?",
    ...
    return [
      {
        ...
        text: `You're spending more on ${topCat.name} this month than your usual average (Γéª${topCat.spent.toLocaleString()}).`,
        badge: "Higher Spend",
      ...
      },
      {
        ...
        text: `At your current spending rate, you're on track to spend approximately Γéª${analyticsData.projectedMonthEnd.toLocaleString()} this month.`,
        badge: "AI Prediction",
      ...
      },
      {
        ...
        text: "Your transportation spending is 7.2% lower than last month. You saved ~Γéª8,500 on commute.",
        badge: "Positive Win",
      ...
      },
      {
        ...
        text: `Setting a Γéª${Math.round(topCat.spent * 0.9).toLocaleString()} cap on ${topCat.name} can free up Γéª15,000 for your emergency fund.`,
  ...
  const handleAskAi = (questionText: string) => {
    ...
    setTimeout(() => {
      ...
      if (lower.includes("where") || lower.includes("most") || lower.includes("category")) {
        ...
        details = [
          `Total spent in ${analyticsData.topCategory.name}: Γéª${analyticsData.topCategory.spent.toLocaleString()}`,
          `Second highest: ${analyticsData.categoriesList[1]?.name || "Transport"} (Γéª${(analyticsData.categoriesList[1]?.spent || 0).toLocaleString()})`,
          `Number of recorded transactions: ${analyticsData.topCategory.count} purchases`,
        ];
        actionableTip = "Consider batching grocery orders or dining out twice a week to trim Γéª18,000 from this category.";
        ...
        details = [
          `Food & Dining purchases increased by Γéª16,200`,
        ...
        summary = `Here is your AI tailored plan to save Γéª50,000 next month without compromising essentials:`;
        details = [
          `Trim ${analyticsData.topCategory.name} by 15% (Save ~Γéª22,000)`,
          `Limit Shopping impulse buys to essentials (Save ~Γéª18,000)`,
          `Audit inactive streaming/app subscriptions (Save ~Γéª10,000)`,
        ];
        actionableTip = "Enable Auto-Save on your TallySpends balance right when your income hits.";
      } else {
        summary = `Based on your ${currentMonthLabel} analysis, your total outgoing is Γéª${analyticsData.totalSpent.toLocaleString()} across ${analyticsData.categoriesList.length} categories.`;
        details = [
          `Daily average burn rate: Γéª${analyticsData.dailyAverage.toLocaleString()}/day`,
      ...
      >
          ...
          <View style={styles.summaryTopRow}>
            <View style={styles.summaryTopLeft}>
              ...
              <Text
                ...
                adjustsFontSizeToFit
              >
                Γéª{analyticsData.totalSpent.toLocaleString()}
              </Text>
            </View>
          ...
          >
            <View style={styles.metricItem}>
              ...
              <Text
                ...
                adjustsFontSizeToFit
              >
                Γéª{analyticsData.dailyAverage.toLocaleString()}
              </Text>
            </View>
            ...
            <View style={styles.metricItem}>
              ...
              <Text
                ...
                adjustsFontSizeToFit
              >
                Γéª{analyticsData.projectedMonthEnd.toLocaleString()}
              </Text>
            </View>
          </View>
        </View>
        ...
        >
          <View style={styles.sectionHeaderRow}>
            ...
            >
              <Text style={[styles.miniTagText, { color: theme.accent }]}>
                Weekly View
              </Text>
            </View>
          </View>
          ...
          <View style={styles.chartContainer}>
            <Svg width="100%" height={120} viewBox="0 0 320 120" preserveAspectRatio="none">
              ...
              {/* Grid guide lines */}
              <Path
                d="M 5,20 L 315,20 M 5,60 L 315,60 M 5,100 L 315,100"
                stroke={theme.border}
                strokeWidth={1}
                strokeDasharray="4,4"
              />
              ...
              {/* Area Fill */}
              <Path
                d="M 10,95 C 40,90 70,35 105,40 C 145,45 175,85 210,58 C 245,35 275,18 310,25 L 310,110 L 10,110 Z"
                fill="url(#spendingGradient)"
              />

              {/* Stroke Path */}
              <Path
                d="M 10,95 C 40,90 70,35 105,40 C 145,45 175,85 210,58 C 245,35 275,18 310,25"
                fill="none"
                stroke={theme.accent}
                strokeWidth={2.8}
                strokeLinecap="round"
            ...
            <View style={styles.chartXAxisLabels}>
              <Text style={[styles.axisLabel, { color: theme.textSecondary }]}>Week 1</Text>
              <Text style={[styles.axisLabel, { color: theme.textSecondary }]}>Week 2</Text>
              <Text style={[styles.axisLabel, { color: theme.textSecondary }]}>Week 3</Text>
              <Text style={[styles.axisLabel, { color: theme.accent, fontWeight: "700" }]}>
                Week 4 (Peak)
              </Text>
            </View>
          </View>

          <View style={styles.chartFooterNote}>
            <Ionicons name="information-circle-outline" size={14} color={theme.textSecondary} />
            <Text style={[styles.chartFooterText, { color: theme.textSecondary }]}>
              Highest spending in Week 4 (Γéª74,200), primarily in Food & Dining.
            </Text>
          </View>
        </View>

        {/* 5. AI-Generated Spending Plan (SPACIOUS, 100% RESPONSIVE VERTICAL HIERARCHY) */}
        <View
          style={[
            styles.sectionCard,
            {
        ...
        >
          <View style={styles.sectionHeaderRow}>
            <View style={styles.sectionHeaderTitleCol}>
              <View style={styles.headerTitleInlineRow}>
                ...
                >
                  <Text style={[styles.aiBadgeSmallText, { color: theme.accent }]}>
                    Γ£¿ AI Recommended
                  </Text>
                </View>
              </View>
              <Text style={[styles.cardSubtitle, { color: theme.textSecondary }]} numberOfLines={1}>
                Recommended limits based on transaction history
              </Text>
            </View>
          </View>

          {/* Philosophy Banner: AI Recommends. User controls. */}
          <View
            style={[
          ...
          >
            ...
            <Text style={[styles.philosophyText, { color: theme.textSecondary }]}>
              AI recommends limits. Tap any card to customize or override.
            </Text>
          </View>

          {/* Categories List (Clean 4-Row Card Design for Total Responsive Harmony) */}
        ...
        <View style={styles.sectionMargin}>
          <View style={styles.sectionHeaderRow}>
            <View style={styles.sectionHeaderTitleCol}>
              ...
              <Text style={[styles.cardSubtitle, { color: theme.textSecondary }]} numberOfLines={1}>
                Personalized observations & spending patterns
              </Text>
            </View>
          </View>
            ...
            {aiInsights.map((insight) => (
              ...
              >
                <View style={styles.insightCardHeader}>
                  <View style={[styles.insightIconCircle, { backgroundColor: insight.bg }]}>
                    <Ionicons name={insight.icon} size={15} color={insight.color} />
                  </View>
                  <View style={[styles.insightBadgePill, { backgroundColor: insight.bg }]}>
                    <Text style={[styles.insightBadgeText, { color: insight.color }]} numberOfLines={1}>
                      {insight.badge}
                    </Text>
                  </View>
                </View>
                <Text style={[styles.insightCardTitle, { color: theme.textPrimary }]} numberOfLines={1}>
                  {insight.title}
                </Text>
                <Text style={[styles.insightCardBody, { color: theme.textSecondary }]}>
                  {insight.text}
                </Text>
              </View>
            ))}
        ...
        >
          ...
          >
            <TextInput
              ...
              placeholder="e.g. Can I afford Γéª40,000 this weekend?"
          ...
          <View style={styles.modalOverlay}>
            <TouchableWithoutFeedback>
              ...
              >
                ...
                >
                  <Text style={[styles.currencyPrefix, { color: theme.textPrimary }]}>Γéª</Text>
                  <TextInput
